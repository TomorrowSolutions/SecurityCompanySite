...
namespace test.Controllers
{
    public class GuardedObjectsController : Controller
    {
        ...
        public GuardedObjectsController(SecurityCompanyDbContext context)
        {
            _context = context;
        }
        ...
        {
              return View(await _context.GuardedObjects.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,City,Street,Building")] GuardedObject guardedObject)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SecurityCompanyDbContext.GuardedObjects'  is null.");
            }
            var guardedObject = await _context.GuardedObjects.FindAsync(id);
            if (guardedObject != null)
            {
        ...
        {
          return _context.GuardedObjects.Any(e => e.Id == id);
        }
    }
}
